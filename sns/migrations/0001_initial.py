# Generated by Django 3.2.9 on 2022-06-15 01:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 15, 10, 20, 19, 972053))),
                ('update_at', models.DateTimeField(default=datetime.datetime(2022, 6, 15, 10, 20, 19, 972063))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 15, 10, 20, 19, 973115))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expired_at', models.DateTimeField(default=datetime.datetime(2022, 6, 15, 11, 20, 19, 971093))),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 15, 10, 20, 19, 972884))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 15, 10, 20, 19, 973326))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 15, 10, 20, 19, 972591))),
                ('board', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sns.boards')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
