# Generated by Django 3.2.9 on 2022-06-16 10:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.UUID('2e98d292-3e8b-49fb-9891-686a24ac49b8'), editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 16, 19, 18, 46, 423403))),
                ('update_at', models.DateTimeField(default=datetime.datetime(2022, 6, 16, 19, 18, 46, 423413))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 16, 19, 18, 46, 424472))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expired_at', models.DateTimeField(default=datetime.datetime(2022, 6, 16, 20, 18, 46, 422514))),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 16, 19, 18, 46, 424242))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 16, 19, 18, 46, 424705))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 16, 19, 18, 46, 424004))),
                ('board', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sns.boards')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
