# Generated by Django 3.2.9 on 2022-06-17 10:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.UUID('5ea519c1-2296-4acc-8196-51ac3f07c1de'), editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 17, 19, 18, 38, 241930))),
                ('update_at', models.DateTimeField(default=datetime.datetime(2022, 6, 17, 19, 18, 38, 241941))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 17, 19, 18, 38, 243486))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expired_at', models.DateTimeField(default=datetime.datetime(2022, 6, 17, 20, 18, 38, 240989))),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 17, 19, 18, 38, 242722))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 17, 19, 18, 38, 243732))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(default=datetime.datetime(2022, 6, 17, 19, 18, 38, 242486))),
                ('board', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sns.boards')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
